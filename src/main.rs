...
fn main() {
    let mut grid = grid::Grid::new(51, 51, 0.0); // Create a small 5x5 grid with initial concentration of 0.0
    grid.set_value(25, 25, 1.0); // Set a central point with higher concentration
   ...
   grid.print();
    ...
    let dy = 1.00; // Spatial step in the y direction
    let D = 0.50; // Diffusion coefficient
